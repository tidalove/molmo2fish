...
class InterleavedTextPreprocessor:
    """
    Build tensor inputs from text that is interleaved with tokens from other modalities

    Supports multi-annotation data where we have many annotations for one multi-modal input.
    """
    tokenizer: Any = None
